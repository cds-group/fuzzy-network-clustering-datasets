...
## Fuzzy clustering of networks (replace with manuscript title)
...
#### Synthetic datasets
1. LFR networks: <br /> The [LFR.zip](GraphData/Synthetic/LFR.zip) dataset was generated using the Lancichinetti–Fortunato–Radicchi (LFR) benchmark method with mixing parameters (μ) 0.1, 0.5 and 0.8. O.<br />
#classes = 3,  #graphs = 300 (100 with 0.1μ - class1, 100 with 0.5μ - class2 and 100 with 0.8μ),  #nodes = 81.
...
#### Real-world datasets
1. European Air Transportation Network:<br />


2. FAO Trade Network :<br />
